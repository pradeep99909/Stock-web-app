...
<div id='market' >
  <div id='market_text' style="color:#008db1;font-size:19px;font-family:sans-serif;font-weight:bold;">Market</div>
  <div id='market_main'>
    <div id='market_part'>
      <div id='market_box'>
        ...
        <div id='stock_main_bottom'><a href='gainers.php'>View More</a></div>
      </div>
      <div id='market_box'>
    ...
    <div id='market_part'>
      <div id='market_box'>
        ...
        <table>
          <?php
            function most_active(){
              $string="SELECT * from nse ORDER BY VOLUME DESC LIMIT 6";
              $result=mysqli_query($GLOBALS['conn'],$string);
        ...
        <div id='stock_main_bottom'><a href='mostactive.php'>View More</a></div>
      </div>
    </div>
  </div>
</div>
