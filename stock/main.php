  ...
  <div id='all'>
    ...
    <div id='home'>
      ...
      <div id='home_part'>
        <div id='home_chart'>
          <p>NSE</p>
                                ...
                                "container_id": "tradingview_48e25"
                              }
                                );
                                </script>
      ...
      <div id='home_part'>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/1NqGRRS-ESg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
	    </div>
      <div id='home_part'>
        <div id='stock_main'>
          <p style='color:#008db1;font-weight:bold;font-family:sans-serif;'>Top Gainers</p>
          <div id='stock_box'>
            <?php
              get_gainers();
             ?>
        ...
        <div id='stock_main'>
          <p style='color:#008db1;font-weight:bold;font-family:sans-serif;'>Top Loosers</p>
          <div id='stock_box'>
            <?php
              get_loosers();
             ?>
...
<a href="https://www.000webhost.com/1122123.html" target="_blank"><img src="https://www.000webhost.com/images/banners/728x90/1.jpg" alt="Web hosting" width="728" height="90" border="0" /></a>
