...
$string1="SELECT * from admin_user where email='".$email."'";
...
if(mysqli_num_rows($result1)==1){
  ...
  $string2="INSERT into admin_user(first_name,last_name,email,phone_number,gender,date_of_birth,password) values('$fname','$lname','$email','$phone','$gender','$dob','$en_password')";
  ...
  if($result2){
    ...
    echo "
      <script>
        window.alert('Thank you for registeration account will given an access soon!');
...
<body>
  ...
  <div id='register_main'>
    ...
    <div id='register_box' style='display:inline;font-size:16px;'>
      Registered?<a href="adminlogin.php" style='color:#008db1;'>Login here</a>
    </div>
  </div>
</form>
  </div>
...
<footer>
  ...
  <div id='footer_box'>
    ...
    <div id='footer_box_menu'>
      <div id='circle'><a href="#" class="fa fa-facebook"></a></div>
      <div id='circle'><a href="#" class="fa fa-facebook"></a></div>
      <div id='circle'><a href="#" class="fa fa-facebook"></a></div>
      <div id='circle'><a href="#" class="fa fa-facebook"></a></div>
    </div>
